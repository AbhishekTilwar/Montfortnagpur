              ...
              {link.hasDropdown ? (
                <div className="relative">
                  ...
                  >
                    ...
                    <ChevronDown 
                      size={16} 
                      className={`transition-transform ${aboutDropdown ? 'rotate-180' : ''}`}
                    />
                  </button>
...
const LandingPage = () => {
  ...
  return (
    <div className="font-sans text-slate-900 selection:bg-[#c5a059] selection:text-white">
      ...
      {/* Right Side Social Widget */}
      <motion.div
        initial={{ x: 100, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ delay: 1.5, duration: 0.8 }}
        className="fixed right-4 top-1/2 -translate-y-1/2 z-40 bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-4 border border-gray-100"
      >
        <div className="flex flex-col gap-3">
          ...
          >
            <a
              ...
              className="block w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
              aria-label="Facebook"
            >
              <Facebook size={18} />
            </a>
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-10 h-10 bg-red-600 rounded-full flex items-center justify-center text-white hover:bg-red-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
              aria-label="YouTube"
            >
              <Youtube size={18} />
            </a>
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-10 h-10 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center text-white hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-10 h-10 bg-sky-500 rounded-full flex items-center justify-center text-white hover:bg-sky-600 transition-colors duration-300 shadow-lg hover:shadow-xl"
              aria-label="Twitter"
            >
              <Twitter size={18} />
            </a>
          ...
          >
            <a
              href="https://wa.me/919975047841"
              target="_blank"
              rel="noopener noreferrer"
              className="block w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 transition-colors duration-300 shadow-lg hover:shadow-xl"
              aria-label="WhatsApp"
            >
          ...
          <div className="border-t border-gray-200 pt-3 mt-2">
            ...
            >
              <a
                href="/fees"
                className="block w-10 h-10 bg-[#c5a059] rounded-full flex items-center justify-center text-white hover:bg-[#b08d4a] transition-colors duration-300 shadow-lg hover:shadow-xl group"
                aria-label="Fees"
              >
