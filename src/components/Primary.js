    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-4xl font-bold text-[#1a2e5a] text-center mb-8">Primary Faculty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Ms. Neha Gupta', qualification: 'M.Sc., B.Ed.', experience: '12 years', subject: 'Science' },
              { name: 'Ms. Priya Nair', qualification: 'M.A., B.Ed.', experience: '10 years', subject: 'English' },
              { name: 'Mr. Rahul Kumar', qualification: 'M.Sc., B.Ed.', experience: '8 years', subject: 'Mathematics' },
              { name: 'Ms. Anita Singh', qualification: 'M.A., B.Ed.', experience: '15 years', subject: 'Hindi' },
              { name: 'Mr. Vijay Patil', qualification: 'M.Sc., B.Ed.', experience: '11 years', subject: 'Computer' },
              { name: 'Ms. Sneha Reddy', qualification: 'M.A., B.Ed.', experience: '9 years', subject: 'Social Studies' }
            ].map((teacher, index) => (
              <motion.div 
                key={index}
